...
use crate::{PeerError, Providers, RandomProvider, TimeProvider};
...
pub enum OpResult {
    ...
    Sent {
        /// Sequence ID of the sent message.
        sequence_id: u64,
...
pub struct OpWeights {
    /// Weight for sending reliable messages.
    pub send_reliable: u32,
    /// Weight for sending unreliable messages.
    pub send_unreliable: u32,
    /// Weight for blocking receive.
    pub receive: u32,
    /// Weight for non-blocking try receive.
    pub try_receive: u32,
    /// Weight for forcing reconnection.
    pub force_reconnect: u32,
    /// Weight for checking metrics.
    pub check_metrics: u32,
    /// Weight for small delay.
    pub small_delay: u32,
}
