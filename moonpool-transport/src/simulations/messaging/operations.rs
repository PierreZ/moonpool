...
pub struct RpcClientOpWeights {
    /// Weight for sending requests.
    pub send_request: u32,
    /// Weight for awaiting responses.
    pub await_response: u32,
    /// Weight for awaiting with timeout.
...
pub struct RpcServerOpWeights {
    /// Weight for trying to receive requests.
    pub try_receive: u32,
    /// Weight for sending responses.
    pub send_response: u32,
    /// Weight for dropping promises.
