...
- `cargo xtask sim run rpc-qualification` (sancov-instrumented, `until_coverage_stable(10, 1000)`, every seed twice under the canary): 124 seeds, 0 failed, 81 of 81 sometimes assertions hit, coverage stable at 28,236 of 70,459 edges for 10 seeds; re-run on the final commit: 98 seeds, 0 failed, 80 of 80 evaluated sometimes assertions hit (the optional "resent call refused while draining, earlier copy left" was not reached that time), 28,079 edges.
