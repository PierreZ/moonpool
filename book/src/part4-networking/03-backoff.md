...
For simulation tests, the default profile works well. The `TimeProvider` abstraction allows stretching or shortening delays to explore timing-sensitive code paths.
